                ...
                <div style={windowStyle}>
                    <div style={styles.topBar} onMouseDown={onMouseDownTopBar}>
                        ...
                        <div style={styles.windowBtns} onMouseDown={(e) => e.stopPropagation()}>
                            ...
                            <button style={styles.winBtn} onClick={() => setIsMaximized((m) => !m)} title="Maximize">
                                ☐
                            </button>
                    ...
                    <div style={styles.controls}>
                        ...
                        <div style={styles.ctrlBtns}>
                            ...
                            <button style={{ ...styles.ctrlBtn, ...styles.hangBtn }} onClick={endCall} title="Hang up">
                                📞
                            </button>
                        </div>
                    </div>
